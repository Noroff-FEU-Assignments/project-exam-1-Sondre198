...
let featuredRecipes = await fetch(api + "/posts?per_page=100&").then(r => r.json())
...
latestRecipeImg.src = latestRecipes0.content.rendered[0];
...
latestRecipeImg1.src = latestRecipes1.content.rendered[1];
...
latestRecipeImg2.src = latestRecipes2.content.rendered[2];
